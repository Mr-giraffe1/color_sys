<!-- <template>
  <div class="home">
    <div class="bg" :style="{ background: bgColor }"></div>
    <div style="height: 50px;width: 120px;border: 1px solid black;">123321</div>
    <div class="container">
      ...
      <div class="content">
        <div class="content-color">
          <div
            ...
            v-for="(item, index) in currentCmky"
            :key="item.title"
          >
            <div class="circle-title">{{ CMYKName[index] }}</div>
            ...
            <div class="circle-right">
              ...
              <div
                ...
                style="display: none"
                v-else
                :style="{ transform: `rotate(${3.6 * currentCmky[index]}deg)` }"
              ></div>
            </div>
...
import NumRgb from "@/components/Num";
      ...
      this.$axios({
        ...
        if (res != null) {
          res.data.forEach((item) => {
            // console.log(item);
            var coloritem = {
              CMYK: [parseInt(item.c), item.m, item.y, parseInt(item.k)],
